...
//         ]);
//
//         var options = {'title':'Annual Performance',
//                        'width':450,
//                        'height':250};
//
...
//
// $('#notificationMessage').addClass('hidden').setTimeOut(fadeOutEffect,3000);
//
// function fadeOutEffect()
// {
//     var fadeTarget = document.getElementById("notificationMessage");
...
// if (document.querySelector('#changePwdForm')) {
//     var vm =  new Vue({
//         el: "#changePwdForm",
//         data: {
//             name: '',
