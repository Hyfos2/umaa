                                            ...
                                            <div class="peer peer-greed w-70p@lg+ w-100@lg- p-20" style="height: 1600px;">
                                                ...
                                                <div id="tabs">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        @include('newAdmin.secondary.levels.teachers.formOne')
                                                        @include('newAdmin.secondary.levels.teachers.formTwo')
                                                        @include('newAdmin.secondary.levels.teachers.formThree')
                                                        @include('newAdmin.secondary.levels.teachers.formFour')
                                                        @include('newAdmin.secondary.levels.teachers.formFive')
                                                        @include('newAdmin.secondary.levels.teachers.formSix')
                                                ...
                                                {{--<input type="text" aria-label="Find or create a branch…" id="context-commitish-filter-field" class="formteachers-control js-filterable-field js-navigation-enable" placeholder="Find or create a branch…">--}}
                                                {{--</div>--}}
                                                ...
                                                {{--<!-- '"` --><!-- </textarea></xmp> --><formteachers class="js-create-branch select-menu-item select-menu-new-item-formteachers js-navigation-item js-new-item-formteachers" action="https://github.com/Hyfos2/eps-system/branches" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="75TC+5lUCa310/U7lgRVqN/5kTItNq3bd0b5zG8m0q8A78Wlv1xKvScVWm/FdaketEpZY5syQh50k0neVqoA4A==">--}}
