<div class="footer container-lg px-3" role="contentinfo">
    <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
        ...
        <a aria-label="Homepage" title="GitHub" class="footer-octicon" href="javascript:void(0);">
        ...
        <ul class="list-style-none d-flex flex-wrap ">
            <li class="mr-3"><a data-ga-click="Footer, go to contact, text:contact" href="javascript:void(0);">Contact Brian Technologies</a></li>
            <li><a data-ga-click="Footer, go to about, text:about" href="javascript:void(0);">About</a></li>
